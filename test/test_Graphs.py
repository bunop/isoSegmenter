...
class test_BaseGraph(unittest.TestCase):
    ...
    def test_SetFontSize(self):
        ...
        self.assertRaises(GClib.Graphs.BaseGraphError,
                          self._test_BaseGrap.SetFontSize, (5,))
    ...
    def test_SetHorizontalLines(self):
        ...
        self.assertRaises(
            GClib.Graphs.BaseGraphError,
            self._test_BaseGrap.SetColorsList)
        ...
        self.assertRaises(
            GClib.Graphs.BaseGraphError,
            self._test_BaseGrap.SetHorizontalLines,
            None)
    ...
    def test_GetColorByGClevel(self):
        ...
        self.assertRaises(
            GClib.Graphs.BaseGraphError,
            self._test_BaseGrap.GetColorByGClevel,
            30)
    ...
    def test_DrawChName(self):
        ...
        self.assertRaises(
            GClib.Graphs.BaseGraphError,
            self._test_BaseGrap.DrawChName,
            "21")
    ...
    def test_SaveFigure(self):
        ...
        self.assertRaises(
            GClib.Graphs.BaseGraphError,
            self._test_BaseGrap.SaveFigure,
            testfile)
...
class test_DrawChromosome(unittest.TestCase):
    ...
    def test_DrawIsochoreRectangles(self):
        ...
        self._test_DrawChromosome.DrawIsochoreRectangles(
    ...
    def test_DrawLegend(self):
        ...
        self._test_DrawChromosome.DrawIsochoreRectangles(
            isochores=self.isochores)
        self.assertRaises(
            GClib.Graphs.DrawChromosomeError,
...
class test_MoreGraphs(unittest.TestCase):
    ...
    def test_HandleGraph(self):
        ...
        self.assertRaises(
            GClib.Graphs.MoreGraphsError,
            self._test_MoreGraphs.AddGraph,
            test)
    ...
    def test_SaveFigure(self):
        ...
        self.assertRaises(
            GClib.Graphs.MoreGraphsError,
            self._test_MoreGraphs.SaveFigure,
            testfile)
